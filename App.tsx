      ...
      <div className="w-full max-w-5xl mx-auto">
        <header className="text-center mb-6">
          ...
          <p className="mt-2 text-lg text-gray-300">
            Use your hands to play the piano in front of your webcam.
          </p>
        </header>
        ...
        <footer className="text-center mt-6 text-gray-500 text-sm">
          <p>Powered by React, Tailwind CSS, and Google MediaPipe</p>
          <p>Hover your fingertips over the keys to play notes.</p>
        </footer>
      </div>
    </main>
  );
